...
> Gemini: Train your 1D CNN in PyTorch using the ai8x-training repository (link: ). This repo contains "wrappers" that ensure your model layers (convolution, activation, etc.) are compatible with the MAX78000 hardware.
